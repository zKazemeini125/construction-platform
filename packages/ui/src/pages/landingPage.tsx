...
export default async function Page({
  ...
  const dict = await getDictionary(locale); // از i18n-config.ts خودت
  return <Welcome text={dict.landing.title} />;
}
...
export default function LandingPage({
  ...
  return (
    <div
      dir={dir}
      className="min-h-screen bg-stone-50 text-stone-900 font-sans antialiased"
    >
      {/* ── Navbar ── */}
      <header
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-stone-300/50 aspect-[4/3] bg-gradient-to-br from-stone-200 to-amber-100">
                ...
                <div className="absolute inset-0 grid grid-cols-3 grid-rows-3 gap-1 p-2">
                  {[
                    {
                      emoji: "🧱",
                      label: locale === "fa" ? "آجر" : "Brick",
                      bg: "bg-orange-200",
                    },
                    {
                      emoji: "📦",
                      label: locale === "fa" ? "سیمان" : "Cement",
                      bg: "bg-stone-300",
                    },
                    {
                      emoji: "🏜️",
                      label: locale === "fa" ? "ماسه" : "Sand",
                      bg: "bg-amber-100",
                    },
                    {
                      emoji: "⚙️",
                      label: locale === "fa" ? "فولاد" : "Steel",
                      bg: "bg-slate-300",
                    },
                    {
                      emoji: "🪵",
                      label: locale === "fa" ? "چوب" : "Wood",
                      bg: "bg-amber-200",
                    },
                    {
                      emoji: "🪣",
                      label: locale === "fa" ? "ملات" : "Mortar",
                      bg: "bg-stone-200",
                    },
                    {
                      emoji: "🏗️",
                      label: locale === "fa" ? "داربست" : "Scaffold",
                      bg: "bg-yellow-100",
                    },
                    {
                      emoji: "🔨",
                      label: locale === "fa" ? "ابزار" : "Tools",
                      bg: "bg-orange-100",
                    },
                    {
                      emoji: "🎨",
                      label: locale === "fa" ? "رنگ" : "Paint",
                      bg: "bg-red-100",
                    },
                  ].map((item, i) => (
                    <div
                    ...
                    >
                      ...
                      <span className="text-[10px] sm:text-xs font-medium text-stone-700">
                        {item.label}
                      </span>
                    </div>
                  ))}
          ...
          <div className="mt-16 lg:mt-20 grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {[
              ...
              >
                <p className="text-3xl lg:text-4xl font-extrabold text-amber-700">
                  {stat.value}
                </p>
          ...
          <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="group relative rounded-2xl border border-stone-200 bg-gradient-to-b from-white to-stone-50 p-8 hover:border-amber-300 hover:shadow-xl transition-all duration-300">
              ...
              <h3 className="text-xl font-bold text-stone-900 mb-2">
                {t.portals.client.title}
              </h3>
              <p className="text-stone-600 text-sm leading-relaxed mb-6">
                {t.portals.client.desc}
              </p>
              <a
                href="/panel/client"
            ...
            <div className="group relative rounded-2xl border border-stone-200 bg-gradient-to-b from-white to-amber-50/50 p-8 hover:border-amber-400 hover:shadow-xl transition-all duration-300 ring-2 ring-amber-200/50">
              ...
              <h3 className="text-xl font-bold text-stone-900 mb-2">
                {t.portals.contractor.title}
              </h3>
              <p className="text-stone-600 text-sm leading-relaxed mb-6">
                {t.portals.contractor.desc}
              </p>
              <a
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 lg:gap-6">
            {t.materials.items.map((item, i) => (
              ...
              >
                ...
                <p className="mt-1 text-xs sm:text-sm text-stone-500 leading-snug">
                  {item.desc}
                </p>
              </div>
            ))}
      ...
      <section id="contact" className="py-16 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-stone-800 via-stone-900 to-amber-950 px-8 py-14 lg:px-16 lg:py-20 text-center">
            ...
            <p className="relative mt-4 text-stone-300 max-w-lg mx-auto">
              {t.cta.subtitle}
            </p>
            <a
              href="#portals"
