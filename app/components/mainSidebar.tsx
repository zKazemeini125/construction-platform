...
export default function MainSidebar() {
  ...
  const [openHref, setOpenHref] = useState<string | null>(`/${locale}/dashboard`);
  ...
  const navItems: NavItem[] = [
    ...
    },
    {
      ...
      children: [
        ...
        { title: sidebar.archivedProjects, href: `/${locale}/projects/archived` },
    ...
    },
    {
      ...
      children: [
        ...
        { title: sidebar.categoriesMaterials, href: `/${locale}/materials/categories` },
      ...
      <nav className="min-h-0 flex-1 overflow-y-auto px-2 py-2 scrollbar-thumb-(--primary-foreground) scrollbar-track-(--muted) scrollbar-thin scrollbar-gutter-stable">
        <ul className="flex flex-col gap-1">
          {navItems.map((item) => {
            ...
            const isOpen = openHref === item.href || (openHref === null && isChildActive);
